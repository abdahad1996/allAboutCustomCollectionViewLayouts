...
class ParallaxFlowLayout: UICollectionViewLayout {
    ...
    //When creating your own subclass of layout parameters, you have to inform your custom layout about this by overriding layoutAttributesClass and returning this class type from the method.
